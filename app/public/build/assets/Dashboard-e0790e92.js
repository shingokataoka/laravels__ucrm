import{j as c,a as r}from"./emotion-react-jsx-runtime.browser.esm-811f184c.js";import{n as e,A as h}from"./AuthenticatedLayout-0eac8c2c.js";import{a as o}from"./app-8ce9871c.js";import{d as t,c as i}from"./DefaultThemeProvider-6dfc8fb6.js";import{T as a}from"./Typography-4bc893b3.js";import"./ApplicationLogo-50c12759.js";import"./transition-c1cd425d.js";import"./ButtonBase-af38a31a.js";function b({auth:d}){const l=t().palette,n=t().spacing;return c(h,{user:d.user,header:r("h2",{className:"font-semibold text-xl leading-tight",children:"サイト説明"}),children:[r(o,{title:"サイト説明"}),r("div",{className:"py-12",children:r("div",{className:"max-w-7xl mx-auto sm:px-6 lg:px-8",children:r("div",{className:"overflow-hidden shadow-sm sm:rounded-lg",css:i`background:${l.bg.color1};`,children:r("div",{className:"p-6",children:c("div",{css:i`
                                    h5, h6 {
                                        margin-top: ${n(4)}
                                    }
                                    p {
