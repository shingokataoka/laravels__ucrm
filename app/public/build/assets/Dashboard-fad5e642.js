import{j as c,a as r}from"./emotion-react-jsx-runtime.browser.esm-afc7ad78.js";import{n as e,A as h}from"./AuthenticatedLayout-fd640e21.js";import{a as o}from"./app-8b3e4287.js";import{d as t,c as i}from"./DefaultThemeProvider-a3a1dc0a.js";import{T as a}from"./Typography-7be4fd55.js";import"./ApplicationLogo-e9c0f09a.js";import"./transition-082a77ae.js";import"./ButtonBase-38d11eb1.js";function b({auth:d}){const l=t().palette,n=t().spacing;return c(h,{user:d.user,header:r("h2",{className:"font-semibold text-xl leading-tight",children:"サイト説明"}),children:[r(o,{title:"サイト説明"}),r("div",{className:"py-12",children:r("div",{className:"max-w-7xl mx-auto sm:px-6 lg:px-8",children:r("div",{className:"overflow-hidden shadow-sm sm:rounded-lg",css:i`background:${l.bg.color1};`,children:r("div",{className:"p-6",children:c("div",{css:i`
                                    h5, h6 {
                                        margin-top: ${n(4)}
                                    }
                                    p {
