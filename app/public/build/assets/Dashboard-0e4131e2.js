import{j as c,a as r}from"./emotion-react-jsx-runtime.browser.esm-282f9dc3.js";import{n as e,A as h}from"./AuthenticatedLayout-68b72068.js";import{a as o}from"./app-05e31e95.js";import{d as t,c as i}from"./DefaultThemeProvider-60793f61.js";import{T as a}from"./Typography-e3e33fd5.js";import"./ApplicationLogo-b0999648.js";import"./transition-c4df1b13.js";import"./ButtonBase-4b7997c0.js";function b({auth:d}){const l=t().palette,n=t().spacing;return c(h,{user:d.user,header:r("h2",{className:"font-semibold text-xl leading-tight",children:"サイト説明"}),children:[r(o,{title:"サイト説明"}),r("div",{className:"py-12",children:r("div",{className:"max-w-7xl mx-auto sm:px-6 lg:px-8",children:r("div",{className:"overflow-hidden shadow-sm sm:rounded-lg",css:i`background:${l.bg.color1};`,children:r("div",{className:"p-6",children:c("div",{css:i`
                                    h5, h6 {
                                        margin-top: ${n(4)}
                                    }
                                    p {
